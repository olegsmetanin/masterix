...
gulp.task('styles', function () {
	return gulp.src(['./src/assets/scss/main.scss','./src/assets/scss/appbootstrap.scss'])
		.pipe(gulpsass({
...
gulp.task('lintyassemble', function() {
	log('Linting Files');
	return gulp.src( './gulp-yassemble/**/*.js') 
		.pipe(jshint('.jshintrc'))
		.pipe(jshint.reporter());
});
...
gulp.task('default', ['bower','lint', 'lintyassemble', 'scripts', 'styles', 'font', 'iconfont', 'img', 'html', 'yassemble', 'serve', 'watch']);
